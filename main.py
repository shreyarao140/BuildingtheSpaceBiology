...
def main():
    ...
    elif args.dataset == 'plant-0' or 'plant-1' or 'plant-2' or 'plant-3' or 'plant-4':
    ...
    elif args.dataset == 'qut-0' or 'qut-1':
    ...
    if args.dataset == 'plankton':
        ...
        test_dataset = datasets.ImageFolder('datasets/flowers102/test/',
                                           transform=val_transform)
        num_classes = 102
    elif args.dataset == 'plant-0' or args.dataset == 'plant-1' or args.dataset == 'plant-2'\
            or args.dataset == 'plant-3' or args.dataset == 'plant-4':
        fold_num = args.dataset.split('-')[1]
        ...
        test_dataset = None
        num_classes = 12
    elif args.dataset == 'qut-0' or args.dataset == 'qut-1':
        fold_num = args.dataset.split('-')[1]
        train_dataset = datasets.ImageFolder(
    ...
    if args.test:
        ...
        print('Test result of {}{} on {}'.format(args.model, pretrained, args.dataset))
        ...
        with open(directory+'result.txt', 'w') as f:
            f.write('Test result of {}{} on {}\n'.format(args.model, pretrained, args.dataset))
